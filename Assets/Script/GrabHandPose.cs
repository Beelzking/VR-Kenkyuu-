...
public class GrabHandPose : MonoBehaviour
{
   ...
   public void SetupPose(BaseInteractionEventArgs arg)
    ...
    public IEnumerator SetHandDataRoutine(HandData h, Vector3 newPosition, Quaternion newRotation, Quaternion[] newBonesRotation, Vector3 startingPosition, Quaternion startingRotation, Quaternion[] startingBonesRotation)
    {
        ...
        [MenuItem("Tools/Mirror Selected Right Grab")]
        ...
        [MenuItem("Tools/Mirror Selected Left Grab")]
    ...
    public void MirrorPose(HandData poseToMirror, HandData poseUsedMirror)
    {
        Vector3 mirroredPosition = poseUsedMirror.root.localPosition;
        mirroredPosition.x *= -1;

        Quaternion mirroredQuaternion = poseUsedMirror.root.localRotation;
        ...
        for (int i = 0; i<poseUsedMirror.fingerBones.Length;i++)
        {
            poseToMirror.fingerBones[i].localRotation = poseUsedMirror.fingerBones[i].localRotation;
        }
    }
}
